...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki2 контрагенты l');

test('testing i-i-s-avtomatizaciya-zakupki2-контрагенты-l', function(assert) {
