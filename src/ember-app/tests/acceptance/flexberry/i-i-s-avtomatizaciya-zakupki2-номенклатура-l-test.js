...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki2 номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupki2-номенклатура-l', function(assert) {
