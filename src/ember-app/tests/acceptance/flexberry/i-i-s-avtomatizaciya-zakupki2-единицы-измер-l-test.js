...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki2 единицы измер l');

test('testing i-i-s-avtomatizaciya-zakupki2-единицы-измер-l', function(assert) {
