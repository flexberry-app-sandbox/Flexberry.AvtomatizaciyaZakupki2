...
moduleForModel('i-i-s-avtomatizaciya-zakupki2-склады', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki2-склады', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki2-склады',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
